...
const Facilities: React.FC = () => {
  return (
    <section id="facilities" className="py-24 px-6 border-y-8 border-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-6xl md:text-8xl font-comic text-black mb-4 uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {FACILITIES.map((facility, i) => (
            <div 
              key={facility.title}
              className={`bg-white/40 backdrop-blur-md border-4 border-black p-4 shadow-[10px_10px_0px_#1a1a1a] transition-transform hover:-translate-y-2 hover:rotate-1 ${
