...
const Facilities: React.FC = () => {
  return (
    <section id="facilities" className="py-16 sm:py-24 px-4 sm:px-6 border-y-8 border-black relative overflow-hidden vintage-paper-texture">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="font-typewriter text-lg sm:text-xl max-w-2xl mx-auto border-t-2 border-black pt-4 font-bold">
            ...
            >
              <div className="aspect-square mb-4 border-2 border-black overflow-hidden relative group">
                <img 
                  ...
                  alt={facility.title}
                  className="w-full h-full object-cover contrast-125 brightness-100 saturate-125 transition-all duration-500"
                />
                <div className="absolute inset-0 bg-[#d32f2f]/5 group-hover:bg-transparent transition-colors"></div>
              </div>
              ...
              <p className="font-typewriter text-[10px] sm:text-sm leading-tight text-black/80 mb-4 font-bold">
