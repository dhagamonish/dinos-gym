  ...
  return (
    <section id="why-choose" className="py-16 sm:py-24 px-4 sm:px-6 relative overflow-visible vintage-paper-texture">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
        ...
        {/* Poster Image - Now Order 1 on Desktop (Left Side) */}
        <div className="relative mt-12 lg:mt-0 px-2 sm:px-4 order-2 lg:order-1">
          <div className="retro-border bg-black p-1 relative shadow-[15px_15px_0px_#000] overflow-hidden group">
            ...
            <div className="absolute inset-0 pointer-events-none p-4 sm:p-8 flex flex-col justify-between">
              <div className="self-end text-right">
                <div className="font-heading text-4xl sm:text-6xl text-white leading-[0.8] tracking-tighter drop-shadow-[4px_4px_0_rgba(0,0,0,0.8)]">
                  THIS <br/> IS <br/> THE
                </div>
              </div>
              ...
              <div className="w-full">
                <div className="font-heading text-[22vw] sm:text-[120px] text-white leading-none tracking-tighter drop-shadow-[6px_6px_0_rgba(0,0,0,0.8)] transform -translate-x-2">
                  GOAL
                </div>
        ...
        {/* Text Content - Now Order 2 on Desktop (Right Side) */}
