      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-12 sm:mb-20 border-b-4 border-dotted border-black pb-12 sm:pb-16 text-center sm:text-left">
          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <p className="font-typewriter text-xs sm:text-sm leading-tight text-black/70 mb-8 max-w-sm mx-auto sm:mx-0">
          ...
          <div>
            <h4 className="font-comic text-xl sm:text-2xl text-[#d32f2f] mb-4 sm:mb-8 uppercase border-b-2 border-black inline-block">MAP YOUR PATH</h4>
          ...
          <div>
            <h4 className="font-comic text-xl sm:text-2xl text-[#d32f2f] mb-4 sm:mb-8 uppercase border-b-2 border-black inline-block">ENROLLMENT</h4>
            <ul className="space-y-2 sm:space-y-4">
          ...
          <div>
            <h4 className="font-comic text-xl sm:text-2xl text-[#d32f2f] mb-4 sm:mb-8 uppercase border-b-2 border-black inline-block">THE SOCIALS</h4>
            <div className="flex flex-col space-y-2 sm:space-y-4">
              <a href={INSTAGRAM_URL} className="font-typewriter text-[10px] sm:text-sm font-bold hover:text-[#d32f2f] uppercase transition-colors">
                Instagram Feed
              </a>
            ...
            <div className="mt-6 sm:mt-8 flex flex-wrap justify-center sm:justify-start gap-2">
              <span className="bg-black text-white px-2 py-1 font-comic text-[8px] sm:text-[10px] uppercase">#DINOSGYM</span>
              <span className="bg-[#d32f2f] text-white px-2 py-1 font-comic text-[8px] sm:text-[10px] uppercase">#REALIRON</span>
              <span className="bg-yellow-400 text-black px-2 py-1 font-comic text-[8px] sm:text-[10px] uppercase">#SOLIHULL</span>
            </div>
          </div>

        </div>

        <div className="flex flex-col md:flex-row justify-between items-center gap-6 font-typewriter text-[8px] sm:text-[12px] text-black font-bold uppercase text-center md:text-left">
          <p>© 1994-2026 DINO'S GYM SOLIHULL. ALL RIGHTS RESERVED.</p>
          <div className="flex gap-6 sm:gap-12 underline decoration-2 decoration-[#d32f2f]">
