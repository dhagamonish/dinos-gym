...
const About: React.FC = () => {
  return (
    <section id="about" className="py-16 sm:py-24 px-4 sm:px-6 relative overflow-hidden vintage-paper-texture">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-6 text-black text-base sm:text-lg leading-relaxed font-bold bg-white/60 backdrop-blur-sm p-6 sm:p-8 border-4 border-black shadow-[8px_8px_0px_#000]">
            ...
            <div className="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-[#fbc02d] text-black p-4 border-4 border-black shadow-[4px_4px_0px_#000]">
                <h4 className="font-comic text-2xl uppercase">THE IRON</h4>
                <p className="text-xs font-bold uppercase">Forged in Solihull for over 30 years.</p>
              </div>
              <div className="bg-[#d32f2f] text-white p-4 border-4 border-black shadow-[4px_4px_0px_#000]">
                ...
                <p className="text-xs font-bold uppercase">Build the character of a champion.</p>
              </div>
            </div>
          </div>
