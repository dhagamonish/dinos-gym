...
const About: React.FC = () => {
  return (
    <section id="about" className="py-24 px-6 relative overflow-hidden bg-white/50 border-y-8 border-black">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="mt-10 grid grid-cols-2 gap-4">
              <div className="bg-[#26a69a] text-white p-4 border-4 border-black transform rotate-1">
              ...
              <div className="bg-[#d32f2f] text-white p-4 border-4 border-black transform -rotate-1">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="retro-border bg-white p-3 transform rotate-2">
              <img 
                src="https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=2069&auto=format&fit=crop" 
                alt="Gym Interior"
                className="w-full h-auto grayscale contrast-150"
              />
              <div className="absolute -bottom-6 -left-6 bg-yellow-400 text-black border-4 border-black p-4 font-comic text-3xl transform -rotate-6">
                ICONIC!
              </div>
            </div>
          </div>
