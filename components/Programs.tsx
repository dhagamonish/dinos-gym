...
const Programs: React.FC = () => {
  return (
    <section id="programs" className="py-24 px-6 bg-white relative">
      <div className="max-w-7xl mx-auto">
        <div className="border-8 border-black p-12 relative bg-[#fdf1d6]">
          {/* Section Header */}
          <div className="absolute -top-10 left-10 bg-[#d32f2f] text-white border-4 border-black px-8 py-2 font-comic text-4xl transform -rotate-2">
            THE DINO METHOD!
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mt-8">
            <div className="lg:col-span-1">
              <h2 className="text-5xl font-comic-bold leading-none mb-6 italic uppercase">
              ...
              <img 
                ...
                className="w-full grayscale border-4 border-black mb-4 shadow-[8px_8px_0px_#000]"
                alt="Muscle Training"
              />
            </div>
            ...
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
              {PROGRAMS.map((p) => (
                <div key={p.id} className="bg-white border-4 border-black p-6 relative group hover:bg-[#26a69a]/10 transition-colors">
                  <div className="absolute -top-4 -right-4 bg-yellow-400 border-2 border-black w-10 h-10 flex items-center justify-center font-comic text-2xl rotate-12">
                    {p.id}
                  </div>
